...
export default function ReceiptDocument({
  receipt,
  student,
  instituteName = 'The Prism Coaching Center',
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.instituteSubtext}>admin@prismcoaching.edu.pk • www.prismcoaching.edu.pk</Text>
          </View>
          <View>
        ...
        <View style={styles.footer}>
          <View style={styles.footerNote}>
            ...
            <Text>For queries, contact: admin@prismcoaching.edu.pk | Receipt #: {receipt.receipt_number}</Text>
            <Text>Generated by The Prism Coaching Center Management System on {dateStr}</Text>
          </View>
          <View style={styles.stamp}>
            <View style={styles.stampCircle}>
              <Text style={styles.stampText}>PRISM{'\n'}COACHING{'\n'}VERIFIED</Text>
            </View>
          </View>
        </View>
